...
<p></p>
<p>
 <button href="#" class="btn btn-success" type="button" data-toggle="modal" data-target="#exampleModal"> Cad. New Funcionario</button>
</p>
 <h1>Registros dos Funcionario</h1>

 <table class="table table-striped" id="example" style="width:100%">
   <caption>Registros das Funcionario</caption>
   <tr>
...
<?php foreach ($registros as $registro ) { ?>
  <tr>
   ...
   href="deletar_funcionario.php?id=<?php echo $registro->idfuncionario;?>" target="_blank">Deletar</a>
...
<?php } ?>
 ...
 <p>
  <a href="logout_funcionario.php" class="btn btn-danger" type="button" > Sair</a>
 </p>
