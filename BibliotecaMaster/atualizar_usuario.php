  ...
  <?php foreach ($registros as $registro) { ?>
    <tr>
      ...
      <td>
        ...
        <a href="atualizar_usuario.php?id=<?php echo $registro->cod_usu; ?>"class="btn btn-primay">Editar</a>
        <a class="btn btn-danger" href="deletar_usuario.php?id=<?php echo $registro->cod_usu;?>" target="_blank">Excluir</a>
