...
<p>
 ...
 <table class="table table-striped" id="example" style="width:100%">
   <caption>Registros das Clientes</caption>
   <tr>
...
<?php foreach ($registros as $registro ) { ?>
  <tr>
   ...
   href="deletar_cliente.php?id=<?php echo $registro->idpessoa;?>" target="_blank">Deletar</a>
...
<?php } ?>
 ...
 <p>
  <a href="logout_cliente.php" class="btn btn-danger" type="button" > Sair</a>
 </p>
